...
1. **Ask a question** using the chat input below
2. **Upload a file** — attach a `.flogo`, `.bwp`, `.log`, or `.zip` to any message
3. **Use a starter** — click one of the suggestion chips to jump straight into a common workflow
